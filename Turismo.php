    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 my-3 px-4">
          <h4>logotipo</h4>
          <p class="mb-0">logomaca</p>
        </div>
        <div class="col-md-6 border-left my-3 px-4">
          <div class="row">
            <div class="col-md-12 text-center" style=""> <i class="d-block fa fa-stop-circle mb-3 text-muted fa-3x"></i>
    ...
    <div class="container">
      <div class="container"><a class="navbar-brand" href="#">
        ...
        <div class="row"><a class="navbar-brand" href="#">
          ...
          <div class="text-l d-md-flex col-md-12 align-items-center justify-content-start"><a class="navbar-brand" href="#">
            </a>
            <ul class="nav d-inline-flex justify-content-start text-right">
              <li class="nav-item"><a class="nav-link active" href="Turismo.html">Home</a> </li>
              <li class="nav-item"> <a class="nav-link" href="Quem samos.html">Quem samos</a> </li>
              <li class="nav-item"> <a class="nav-link" href="Tows.html">Tows</a> </li>
              <li class="nav-item"> <a class="nav-link" href="Pacote.html">Pacote</a> </li>
        ...
        <div class="col-md-12" style="">
          <div class="carousel slide" data-ride="carousel" id="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item active"> <img class="d-block img-fluid w-100" src="https://static.pingendo.com/cover-bubble-light.svg" height="250px">
                <div class="carousel-caption">
                  <h5 class="m-0">Carousel</h5>
                  <p>b</p>
                </div>
              </div>
              <div class="carousel-item"> <img class="d-block img-fluid w-100" src="https://static.pingendo.com/cover-moon.svg" height="250px">
                <div class="carousel-caption">
                  <h5 class="m-0">Carousel</h5>
                  <p>with controls</p>
                </div>
